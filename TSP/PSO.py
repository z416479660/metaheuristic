# reference: https://github.com/kellenf/TSP_collection/tree/master
# 我的感觉和遗传算法没有什么区别
import random
import math
import numpy as np
...
class PSO(object):
    def __init__(self, num_city, data):
        ...
        self.particals = self.greedy_init(self.dis_mat,num_total=self.num,num_city =num_city)  #使用贪心算法初始化粒子
